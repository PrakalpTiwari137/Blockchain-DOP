...
class Node():
    ...
    def send_vote_req(self):
        ...
        #When you create a Thread, you pass it a function 
        #and a list containing the arguments to that 
        #function. 
    ...
    def update_follower_commitIdx(self, follower):
        #print("Inside update_follower_commitIdx\n")
        route = "heartbeat"
    ...
    def heartbeat_reply_handler(self, term, commitIdx):
        #print("Inside heartbeat_reply_handler\n")
    ...
    # if it is a comm it it releases the lock
    def spread_update(self, message, confirmations=None, lock=None):
        #print("Inside spread_update\n")
